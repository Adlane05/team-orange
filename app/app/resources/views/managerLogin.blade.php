...
<body style="margin:0px; height:100%; background-color:#d9d9d9; font-family: Helvetica, Sans-Serif;">
    ...
    <div style="text-align:center; display:block">
        <form action="" method="POST" id="login">
            ...
            <input type="text" id="username" name="username" maxlength="10" oninput="this.value = this.value.replace(/[^0-9]/g, '')" autocomplete="off" style="border-radius:15px; border:3px solid black; height:3vh; width:12vw; padding:10px; font-size:50px; margin-bottom:3%; text-align:center;"> <br>
